-- USER-CENTER-COMPAT runtime invariants and query paths.
-- The unique relation index is required by the explicit four-column
-- ON CONFLICT target used for idempotent collection writes.
