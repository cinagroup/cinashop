...
const criticalSources = [
  ...
  "src/controllers/api/v1/CityDeliveryCallbackController.ts",
  ...
  "src/services/delivery/CityDeliveryCallbackService.ts",
...
const requiredEvents = [
  ...
  "city_delivery_callback_rejected",
  "city_delivery_callback_persisted",
  "city_delivery_callback_persist_failed",
  "city_delivery_callback_outbox_dispatched",
  "city_delivery_callback_dispatch_failed",
  "city_delivery_callback_consumed",
  "city_delivery_callback_conflict",
  "city_delivery_callback_dead",
  "city_delivery_callback_failed",
  "city_delivery_reconciliation_attention",
