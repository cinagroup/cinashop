/** Exact bundled copy of migrations/0115_work_client_current_projection.sql. */
export const WORK_CLIENT_CURRENT_PROJECTION_SQL = String.raw`-- Expand-only canonical Enterprise WeChat external-contact projection. Legacy
