import { ADMIN_REFUND_CREATION_SQL } from './adminRefundCreation';
import { ADMIN_REFUND_CREATION_COMPATIBILITY_SQL } from './adminRefundCreationCatalog';

/** External0156/embedded0162. Explicit owner transaction, no startup hook,
 * backfill, privilege repair or replacement of a preexisting receipt table. */
export const ADMIN_REFUND_CREATION_INSTALLATION_SQL = `
...
BEGIN
  ...
  SELECT * INTO state FROM (${ADMIN_REFUND_CREATION_COMPATIBILITY_SQL}) c;
