// SQL is mirrored in migrations/0151_coupon_product_scope_fence.sql.
// Embedded step 0157; existing databases use the explicit maintenance runner.
export const COUPON_PRODUCT_SCOPE_FENCE_SQL = String.raw`
...
const fenceSourceParts = COUPON_PRODUCT_SCOPE_FENCE_SQL.split('$fence_source$');
if (fenceSourceParts.length !== 3 || !fenceSourceParts[1]) throw new Error('Invalid coupon scope fence source');
export const COUPON_PRODUCT_SCOPE_FENCE_BODY = fenceSourceParts[1];
