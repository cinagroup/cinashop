// Shared fixed read-only queries for the auditors and filesystem/embedded installer.
// No observed database content is used to construct the expected contract.
export const SHIPPING_LIFECYCLE_SHAPE_SQL = String.raw`
...
export const SHIPPING_LIFECYCLE_BASELINE_SQL = String.raw`
...
export const SHIPPING_LIFECYCLE_BOUND_SQL = String.raw`
...
export const SHIPPING_LIFECYCLE_LOCK_SQL = String.raw`
