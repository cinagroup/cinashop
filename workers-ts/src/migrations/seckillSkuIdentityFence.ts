/** Exact bundled copy of migrations/0166_seckill_sku_identity_fence.sql. */
export const SECKILL_SKU_IDENTITY_FENCE_SQL = String.raw`-- Forward-only identity fence for active seckill SKU rows. Historical retired
