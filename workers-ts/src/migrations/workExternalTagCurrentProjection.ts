/** Exact bundled copy of migrations/0117_work_external_tag_current_projection.sql. */
export const WORK_EXTERNAL_TAG_CURRENT_PROJECTION_SQL = String.raw`-- Expand-only canonical Enterprise WeChat customer-tag catalog projection.
