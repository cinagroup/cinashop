...
export const OFFLINE_CATALOG_VERSIONS: { fresh: Record<string, string>; v1: Record<string, string> } = {
  ...
  v1: {
    ...
    offline_order_query_evidence: 'a12ec8ef9b7a9ca4c32f42616190edb6c20fb8f1665b450c16ab8bd474e33e6e',
...
export const OFFLINE_ORM_CATALOG_VERSIONS: Record<string, string> = {
  ...
  offline_order_query_evidence: '3fa09ba5101a8a7d9a5703c160013cf2888b0eac06bceeb711b4bc6c7a6225ca',
