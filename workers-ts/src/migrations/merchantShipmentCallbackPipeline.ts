/** Exact bundled copy of migrations/0123_merchant_shipment_callback_pipeline.sql. */
export const MERCHANT_SHIPMENT_CALLBACK_PIPELINE_SQL = `-- Signature-verified Kuaidi100 merchant-shipment callback inbox, durable
