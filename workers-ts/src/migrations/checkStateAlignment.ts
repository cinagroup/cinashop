/** Exact mirror of external 0144; no I/O. Target CHECK OIDs intentionally change. */
export const CHECK_STATE_ALIGNMENT_SQL = String.raw`-- DB-009E4: eight validation flags and one event-list ordering, with unchanged write rules.
