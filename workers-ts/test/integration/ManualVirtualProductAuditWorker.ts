import { runManualVirtualProductPostgresScenario } from "./ManualVirtualProductPostgresScenario";
  ...
  async fetch(request: Request, env: AuditEnv): Promise<Response> {
    ...
    try {
      return Response.json({
        report: await runManualVirtualProductPostgresScenario(env.HYPERDRIVE.connectionString),
      }, {
        headers: {
      ...
      console.error("[manual-virtual-product-audit] failed", error);
