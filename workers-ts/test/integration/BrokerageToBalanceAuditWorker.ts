import { runBrokerageToBalancePostgresScenario } from "./BrokerageToBalancePostgresScenario";
  ...
  async fetch(request: Request, env: AuditEnv): Promise<Response> {
    ...
    try {
      return Response.json(
        await runBrokerageToBalancePostgresScenario(env.HYPERDRIVE.connectionString),
      );
    } catch (error) {
      return Response.json(
