...
describe.runIf(Boolean(process.env.TEST_FINANCE_POSTGRES_URL))('shipping snapshot independent PostgreSQL boundaries',()=>{
 ...
 const params:CreateOrderParams={uid:11,key:'template_pg',cartIds:[1],shippingType:1,cityId:101,province:'本地省',userAddress:'隔离地址',realName:'隔离',userPhone:'00000000000',userIp:'127.0.0.1'};
